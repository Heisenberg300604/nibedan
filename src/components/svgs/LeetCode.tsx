...
export default function LeetCodeIcon({ className = '', ...props }: React.SVGProps<SVGSVGElement> & { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" id="leetcode" className={`transition-all duration-300 ${className}`} {...props}>
